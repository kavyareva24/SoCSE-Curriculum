...
| ID | Check | Severity | Source |
|---|---|---|---|
| F1 | Remediation path to the awareness level (not generic) — triggered by IA performance is mentioned. | 🔴 Blocker | Guidelines §1.7; Template §8 |
| F2 | Enrichment path to the advanced level mentioned. | 🔴 Blocker | Guidelines §1.7; Template §8 |
...
| I3 | For SC / Workshop / Project / Internship courses: **ownership sits with a SIG/RIO** and the course links into that track's sequence. | 🟠 Major | Guidelines §4.5–§4.6, §4.11–§4.12; Strategy §5.2 |
